...
# -- Project information -----------------------------------------------------
project = 'smartpy'
copyright = '2018-{}, Thibault Hallouin'.format(datetime.now().year)
...
html_baseurl = 'https://thibhlln.github.io/smartpy'

html_logo = '../_doc_img/smartpy-logo.svg'

html_favicon = '../_doc_img/smartpy-favicon.ico'
...
versions = [
    ...
    for tag in repo.tags if tag.name > 'v0.2.1'
]
